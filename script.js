...
var comp = {};
comp.moves = [];
var counter, compNumber, playerColor;
var blueButton, greenButton, redButton, yellowButton;
var blueAudio, greenAudio, redAudio, yellowAudio, wrongAudio;
var startButton, strictModeButton, resetButton, noStrictLayer, strictLayer, strictModeButtonOn;
function preload() {
    ...
    game.load.image("strictLayer", "assets/Layer-22strict.png");
    ...
    game.load.image("yellowCircleButtonS", "assets/leftButtonS.png");
    ...
    game.load.audio("wrongsfx", ["assets/audio/wrong.mp3", "assets/audio/wrong.ogg"]);
    game.load.audio("gsfx", ["assets/audio/green.mp3", "assets/audio/green.ogg"]);
    game.load.audio("rsfx", ["assets/audio/red.mp3", "assets/audio/red.ogg"]);
    game.load.audio("bsfx", ["assets/audio/blue.mp3", "assets/audio/blue.ogg"]);
    game.load.audio("ysfx", ["assets/audio/yellow.mp3", "assets/audio/yellow.ogg"]);
}
function create() {
    ...
    noStrictLayer = game.add.image(257, 258, "greyLayer");
...
function onStrictModeButtonDown() {
    if (player.strictMode === "on") {
        strictModeButton = game.add.sprite(455, 500, "yellowCircleButton");
        player.strictMode = "off";
    } else if (player.strictMode === "off") {
        strictModeButton = game.add.sprite(455, 500, "yellowCircleButtonS");
...
function checkEquality() {
    ...
    if (arraysAreEqual()) {
        ...
        var lenMinusOne = (function () { return player.moves.length - 1; }());
